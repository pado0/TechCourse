...
import ex10_kakaoriding_strategy.Main;
public class RacingCarLevel1 implements RacingCar{
    static public int ctrlCount = 0;
    static protected int distance; //총 누적 거리
